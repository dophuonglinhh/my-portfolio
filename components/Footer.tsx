  ...
  return (
    <footer className="w-full pt-20 pb-10" id="contact">
      ...
      <div className="flex mt-16 md:flex-row flex-col justify-between items-center">
        <p className="md:text-base text-sm md:font-normal text-muted-foreground">
          Copyright © 2025 Linh Do
        </p>
        ...
        <div className="flex items-center md:gap-3 gap-6 mt-6">
          {socialMedia.map((info) => (
            <a
              ...
              className="group w-10 h-10 cursor-pointer flex justify-center items-center backdrop-filter backdrop-blur-lg saturate-180 bg-opacity-75 bg-icon rounded-lg border hover:border-primary hover:border-2"
            >
              <img
                src={info.img}
                alt="icons"
