...
const About = () => {
  return (
    <div id="about" className="flex flex-col justify-center mt-20">
      ...
      <p className="text-start md:tracking-wider mb-4 text-sm">
        ...
        <span className="font-bold"> RMIT SGS Vietnam</span>, where I focus on
        web development and UI/UX design. My academic journey has provided me
        with hands-on experience working on full-stack applications,
        particularly front-end development in team projects.
      </p>
      <p className="text-start md:tracking-wider mb-4 text-sm">
